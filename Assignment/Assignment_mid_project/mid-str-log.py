...
#LOG 에지 검출
image_1_mid_str_gau = cv2.GaussianBlur(image_1_mid_str,(3,3),1)
image_1_mid_str_gau_lap = cv2.Laplacian(image_1_mid_str_gau,-1,1)
image_2_mid_str_gau = cv2.GaussianBlur(image_2_mid_str,(3,3),1)
image_2_mid_str_gau_lap = cv2.Laplacian(image_2_mid_str_gau,-1,1)
image_3_mid_str_gau = cv2.GaussianBlur(image_3_mid_str,(3,3),1)
image_3_mid_str_gau_lap = cv2.Laplacian(image_3_mid_str_gau,-1,1)

image_1_mid_str_gau_lap_final = image_1_mid_str_gau_lap/image_1_mid_str_gau_lap.max()
image_2_mid_str_gau_lap_final = image_2_mid_str_gau_lap/image_2_mid_str_gau_lap.max()
image_3_mid_str_gau_lap_final = image_3_mid_str_gau_lap/image_3_mid_str_gau_lap.max()
